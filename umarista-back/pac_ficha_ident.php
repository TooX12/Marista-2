...
$q="SELECT * FROM ficha_identificacion WHERE id_f_identificacion = '".$id."'";//Variable que contiene el Query y compara si son iguales el usuario y password con las variables $user y $pass.
