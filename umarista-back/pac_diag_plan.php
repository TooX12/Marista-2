...
$q="SELECT * FROM diagnostico_plan WHERE id_paciente = '".$id."'";//Variable que contiene el Query y compara si son iguales el usuario y password con las variables $user y $pass.
