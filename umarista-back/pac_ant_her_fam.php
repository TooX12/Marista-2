...
$q="SELECT * FROM antecedentes_heredo_fam WHERE id_ant_heredo_fam = '".$id."'";//Variable que contiene el Query y compara si son iguales el usuario y password con las variables $user y $pass.
