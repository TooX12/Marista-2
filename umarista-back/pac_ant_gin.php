...
$q="SELECT * FROM antecedentes_gineco WHERE id_antecedentes_gineco = '".$id."'";//Variable que contiene el Query y compara si son iguales el usuario y password con las variables $user y $pass.
