...
$q="SELECT * FROM padecimiento_actual WHERE id_padecimiento_actual = '".$id."'";//Variable que contiene el Query y compara si son iguales el usuario y password con las variables $user y $pass.
