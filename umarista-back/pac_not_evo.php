...
$q=" SELECT * FROM notas_evolucion WHERE id_paciente = '".$id."' ORDER BY fecha";//Variable que contiene el Query y compara si son iguales el usuario y password con las variables $user y $pass.
